...
class RUNetEvaluation:
    def __init__(self, img_size=128, scale_factor=2):
        ...
        self.train_dataloader = DataLoader(ChestCTScanDataset(DATA_ROOT, train_transforms), 1)
        self.test_dataloader = DataLoader(ChestCTScanDataset(DATA_ROOT, test_transforms,is_training_set=False), 1)
